...
public class WebMvcConfiguration implements WebMvcConfigurer {
	...
	private final List<String> includePatterns = Arrays.asList("/board/*", "/plan/*", "/user/*", "/map/*");
	private final List<String> excludePattern = Arrays.asList("/user/login");
...
//		registry.addInterceptor(jwtInterceptor).addPathPatterns(includePatterns)
